<x-front-layout>
    <x-slot name="title">Halaman Tidak Ditemukan - 404</x-slot>
    ...
    <div class="flex flex-col justify-center items-center" style="padding-top: 10rem; padding-bottom: 8rem; min-height: 70vh;">
        <div class="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop text-center animate-fade-in-up">
            <h1 class="font-display-lg text-primary mb-6 font-bold tracking-widest drop-shadow-sm" style="font-size: 8rem; line-height: 1;">404</h1>
            <div class="w-24 h-1 bg-gold mx-auto mb-10 rounded-full"></div>
            <h2 class="font-headline-md text-3xl md:text-4xl text-on-surface mb-6">Halaman Tidak Ditemukan</h2>
